...
export default function PasswordScreenPhone({ onBack, onContinue, error }) {
  ...
  const handleSubmit = () => {
    if (hasValue) onContinue?.(password);
  };
      ...
      <div className="es-root">
        <div className="es-container">
          ...
          <p className="es-subtitle">
            Этот аккаунт защищён паролем.{"\n"}Укажите его, чтобы продолжить
          </p>

          <div className="es-input-wrap">
            <input
              className={`es-input${error ? " error" : ""}`}
          ...
          <div className={`es-error${error ? "" : " hidden"}`}>
